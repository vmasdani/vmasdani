  ...
  "group/alert relative grid w-full gap-0.5 rounded-none border px-2.5 py-2 text-left text-xs has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pr-18 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2 *:[svg]:row-span-2 *:[svg]:translate-y-0 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        success:
          "border-green-600/40 bg-green-50 text-green-700 *:data-[slot=alert-description]:text-green-700/90 *:[svg]:text-green-600 dark:border-green-500/40 dark:bg-green-950/40 dark:text-green-400 dark:*:data-[slot=alert-description]:text-green-400/90 dark:*:[svg]:text-green-500",
        destructive:
